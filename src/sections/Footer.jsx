    ...
    return (
        <footer className="flex flex-col pt-10 md:flex-row md:justify-between gap-5">
            <section className="flex-col justify-center gap-4 sm:justify-start">
                ...
                <p className="mt-2 text-sm lg:text-xl text-orange-200"><a href="#" target="_blank">Terms &
                    Conditions {getYear}</a></p>
            </section>
            <section className="flex flex-col gap-4">
                ...
                <ul className="flex gap-10">
                    <li><a href="https://github.com/HewageNKM" target="_blank"><img src={icons.github} alt="github"
                                                                                    width="30px"/></a></li>
                    <li><a href="https://twitter.com/HewageNKM" target="_blank"><img src={icons.x} alt="github"
                                                                                     width="30px"/></a></li>
