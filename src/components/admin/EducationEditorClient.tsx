...
export default function EducationEditorClient({ id }: { id?: string }) {
    ...
    <div className="text-neutral-900 dark:text-neutral-100 max-w-5xl mx-auto p-4 sm:p-8">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold">
          {id && id !== "new" ? "Edit Education" : "Add Education"}
        </h1>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full p-3 border border-neutral-300 dark:border-neutral-600 rounded-lg 
      focus:ring-2 focus:ring-neutral-500 focus:border-transparent dark:bg-neutral-700 
